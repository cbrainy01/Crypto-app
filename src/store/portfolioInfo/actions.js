...
import { SHOW_COIN_SHOP, HIDE_COIN_SHOP, SAVE_PURCHASED_COIN, REMOVE_PURCHASED_COIN } from "./portfolioInfoReducer";
...
export const savePurchasedCoin = () => (dispatch, getState) => {
    ...
    console.log("finalpurchasedCoin: ", purchasedCoinInfo)
...
export const removePurchasedCoin = (deleteId) => (dispatch, getState) => {
    ...
    const updatedPurchasedCoins = purchasedCoinsArray.filter( (coin) => coin.purchaseId !== deleteId );
