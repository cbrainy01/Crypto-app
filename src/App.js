...
import { GlobalStyle, Container, lightTheme, darkTheme } from "styling";
import './App.css';
    ...
    return(
      <ThemeProvider theme={this.state.isBlacked ? darkTheme : lightTheme}>
        <Container>
          <GlobalStyle/>
          <Router>
            <Navbar handleThemeChange={this.handleThemeChange} handleCurrencyChange={this.handleCurrencyChange} currency={this.state.currency}/>
            <Switch>
